...
`import layout from '../templates/components/validation-component-dropdown'`

ValidationComponentDropdownComponent = Ember.Component.extend
  layout: layout
  keys: {}
  selectedKeys:[]
...
`export default ValidationComponentDropdownComponent`

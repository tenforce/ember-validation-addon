...
`import layout from '../templates/components/validation-component-list'`

ValidationComponentListComponent = Ember.Component.extend
  layout: layout
  keys: {}
  selectedKeys:[]
...
`export default ValidationComponentListComponent`
